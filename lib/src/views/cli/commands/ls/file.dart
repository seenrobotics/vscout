...
class FileCommand extends Command with VscoutCommand {
  ...
  @override
  String get description => 'List entries in the database through JSON File';
  ...
  @override
  run() async {
    final LsDataVM addDataModel = LsDataVM();
    this.results = await addDataModel.lsFileData(argResults.rest[0]);
    print('Entries found \n \n');
